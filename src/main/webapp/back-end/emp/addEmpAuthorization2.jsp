                ...
                <div class="row" style="max-width: 1400px">
                    <nav class="navbar navbar-expand-lg navbar-light fs-md-6" id="header-navbar">
                        ...
                        <a class="navbar-brand font-weight-bold" href="StoreStart.html">
                            <img src="/assets/images/Logo.PNG" style="width: 100px; height: 100px" alt="" />FoodMap</a>
                        <!--            ps-->
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto ">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-uppercase active disabled" data-toggle="none" href="./Backstage-emp.html">
                                        🗃️管理
                                    </a>
                                </li>
                                <li class="nav-item">
            ...
            <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="p-4 pt-5">
                    <ul class="list-unstyled components mb-5">
                        ...
                        <li class="mt-5 mb-5">
                            <a href="#pageSubmenu2" data-toggle="collapse" aria-expanded="false" class="dropdown">
                                <h3>🔻員工資料</h3>
                            </a>
                            <ul class="list-unstyled collapse" id="pageSubmenu2">
                                <li>
                                    <hr><a href="./Backstage-empId.html" class="nav-link">🔆員工查詢</a>
                                </li>
                                <li>
                                    <a href="./Backstage-empAdd.html" class="nav-link">🔆員工新增</a>
                                </li>
                                <hr>
                        </li>
                    </ul>
                    ...
                    <li class="mt-5 mb-5">
                        <a href="#pageSubmenu3" data-toggle="show" aria-expanded="false" class="dropdown">
                            <h3>🔻員工權限</h3>
                        </a>
                        <ul class="list-unstyled" id="pageSubmenu3">
                            <li>
                                <hr><a href="./Backstage-empPer.html" class="nav-link">🔆權限設定</a>
                            </li>
                            <li><a href="#" class="nav-link disabled bg-white" style="color: #216a51;">🔆權限新增</a></li>
                            <hr>
                    </li>
                    </ul>
                    </li>
