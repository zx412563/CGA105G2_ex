				...
				<div class="table-responsive ">
					<table class="table table-striped text-center ">
						...
						<tbody class="code_tbody col-3">
							...
							<tr class="col-3">
								<td><%=(employee.getEmpStatus()==0)? "在職": "離職" %></td>
								<td><%=employee.getEmpId()%></td>
								<td><%=employee.getEmpAcc()%></td>
								<td><%=employee.getEmpPwd()%></td>
								<td><%=(employee.getEmpPer()==0)? "員工": "主管" %></td>
								<td><%=employee.getEmpTime()%></td>
								<td><%=employee.getEmpRtime()%></td>
								<td>
								<FORM METHOD="post"
									ACTION="<%=request.getContextPath()%>/back-end/emp/test"
									style="margin-bottom: 0px;">
									<input type="submit" value="修改"> <input type="hidden"
										name="empId" value=<%=employee.getEmpId()%>> <input
