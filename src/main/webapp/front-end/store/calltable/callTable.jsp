				...
				<div class="row" style="max-width: 1400px">
					<nav class="navbar navbar-expand-lg navbar-light fs-md-6"
						...
						<a class="navbar-brand font-weight-bold"
							href="/CGA105G2/src/main/webapp/front-end/store/store/storeIndex.html">
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							<ul class="navbar-nav ml-auto ">
								...
								<li class="nav-item"><a class="nav-link text-uppercase"
									data-toggle="none"
									href="/CGA105G2/src/main/webapp/front-end/store/store/contactUs.html">
										📭聯繫我們 </a></li>
								<li class="nav-item"><a class="nav-link text-uppercase"
									data-toggle="none"
									href="/CGA105G2/src/main/webapp/front-end/store/food_order/listAllFoodOrder.html">
										🚩訂位 </a></li>
								<li class="nav-item"><a class="nav-link text-uppercase"
									data-toggle="none"
								...
								<li class="nav-item"><a class="nav-link text-uppercase"
									data-toggle="none"
									href="/CGA105G2/src/main/webapp/front-end/store/order/listAllOrder.html">
										📔訂單 </a></li>
								<li class="nav-item"><a class="nav-link text-uppercase"
									data-toggle="none"
