          ...
          <nav class="navbar navbar-expand-lg navbar-light fs-md-6" id="header-navbar">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ml-auto ">
                ...
                <div class="navbar-spacer"></div>
                <li class="nav-item">
                  <a class="nav-link text-uppercase" data-toggle="none" href="/CGA105G2/src/main/webapp/front-end/store/store/contactUs.html">
                    📭聯繫我們
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link text-uppercase" data-toggle="none" href="/CGA105G2/src/main/webapp/front-end/store/food_order/listAllFoodOrder.html">
                    🚩訂位
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link text-uppercase" data-toggle="none" href="/CGA105G2/src/main/webapp/front-end/store/waiting/setWaiting.html">
                    🚩候位
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link text-uppercase active disabled" data-toggle="none"  style="color: #216a51 !important;"  href="/CGA105G2/src/main/webapp/front-end/store/calltable/callTable.html">
                    🚩帶位
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link text-uppercase" data-toggle="none" href="/CGA105G2/src/main/webapp/front-end/store/order/listAllOrder.html">
                    📔訂單
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link text-uppercase" data-toggle="none" href="/CGA105G2/src/main/webapp/front-end/store/store/updateStoreInfo.html">
                    🗃️管理
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link text-uppercase" data-toggle="none" href="/CGA105G2/src/main/webapp/">
                    🚪Sing out
                  </a>
                </li>
              </ul>
...
<!--              today-->
              <label class="input-group-text col-2" >
                <button class="btn btn-secondary form-control  p-0" style="background-color: rgba(9,148,101,0.42);color: white;" id="today">Today</button>
              </label>
<!--              date-->
              <label class="input-group-text col-4" for="datepicker">
                <input  type="text" class="form-control  pl-5" style=" background-color: rgb(9,148,101,0.42);color: white;" id="datepicker" placeholder="yyyy-mm-dd">
              </label>
<!--              time-->
              <label class="input-group-text col-2">
                <select class="btn btn-secondary form-control  p-0" style="background-color: rgba(9,148,101,0.42);color: white;" id="Select01" >
                </select>
              </label>
...
<!--            上-->
            <div>
              <div class="input-group-text">
                <p class="form-control pt-5" style="background-color: rgba(253,72,72,0.65);color: black;">訂位表</p>
              </div>
                  ...
                  <div class="row">
                    <div class="col-12 p-0">
                      <article class="faq p-0">
                        <header class="faq-header" data-toggle="collapse" data-target="#faq1-item-1"
                                aria-expanded="false">
                          <table class="table table-striped m-0">
                            <tbody class="code_tbody">
                            <tr>
                        ...
                        <div class="faq-body collapse" id="faq1-item-1">
                          <div class="card-body d-flex flex-column p-5" data-mh="gift-vouchers">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                              <span class="text-dark">1 <span class="text-muted">×</span> Creeme Soup</span>
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-3">
                              <span class="text-dark">2 <span class="text-muted">×</span> Multi-greens Salad</span>
                              <div class="price fs-6 text-black">
                                <div class="price-currency pr-0">$</div>
...
<!--            下-->
                ...
                <section class="section p-0 " id="faq2" style="overflow-y: scroll;height: 300px">
                  <div class="section-content container">
                    <div class="row">
                      <div class="col-12 p-0">
                        <article class="faq p-0">
                          <header class="faq-header" data-toggle="collapse" data-target="#faq2-item-1"
                                  aria-expanded="false">
                            <table class="table table-striped m-0">
                              <tbody class="code_tbody">
                              <tr>
                          ...
                          <div class="faq-body collapse" id="faq2-item-1">
                            <div class="radio-buttons-group" style="width:100%; justify-content: center">
            ...
            <section class="section p-0 " id="faq3" style="overflow-y: scroll;height: 600px">
              <div class="section-content container">
                <div class="row">
                  <div class="col-12 p-0">
                    <article class="faq p-0">
                      <header class="faq-header" data-toggle="collapse" data-target="#faq3-item-1"
                              aria-expanded="false">
                        <table class="table table-striped m-0">
                          <tbody class="code_tbody">
                          <tr>
              ...
              <div class="section-content container">
                <div class="row">
                  <div class="col-12 p-0">
                    <article class="faq p-0">
                      <header class="faq-header" data-toggle="collapse" data-target="#faq2-item-2"
                              aria-expanded="false">
                        <table class="table table-striped m-0">
                          <tbody class="code_tbody">
                          <tr>
          ...
          <!--      第三欄    -->
          <div class="col-8 p-0 ">
            <div class="d-flex" style="flex-wrap: wrap ;align-content: space-around;height: 100%">
              <div class="col-md-3 p-5">
                <div class="card border-0" style="height: 150px !important;">
                  <div class="card-body p-19 p-md-20 d-flex" style="border: 1px solid black">
