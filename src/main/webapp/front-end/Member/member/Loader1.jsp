					...
					<nav class="navbar navbar-expand-lg navbar-light fs-md-6"
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							<ul class="navbar-nav ml-auto">
								...
								<div class="navbar-spacer"></div>
								<li class="nav-item"><a
									class="nav-link text-uppercase active" style="color: #216a51;"
									data-toggle="none"
								...
								<li class="nav-item"><a class="nav-link text-uppercase "
									...
									href="/CGA105G2/front-end/member/code/listAllCode.html">
										🗃️管理 </a></li>
								<li class="nav-item"><a class="nav-link text-uppercase"
									data-toggle="none" href="/CGA105G2/"> 🚪Sing out </a></li>
							</ul>
						</div>
					</nav>
				</div>
	...
	<div class="container-fluid">
		<div class="row">
					...
					<ul class="list-unstyled components mb-5">
						...
						<li>
							...
							<ul class="list-unstyled collapse" id="pageSubmenu1">
								<li>
									<hr> <a class="nav-link "
									href="/CGA105G2/front-end/member/code/listAllCode.html">🔆有效優惠券</a>
								</li>
								<li><a class="nav-link "
									href="/CGA105G2/front-end/member/code/selectCodeHistory.html">🔆歷史查詢</a>
									<hr></li>
							</ul>
						</li>
						<li><a href="#pageSubmenu2" data-toggle="collapse"
							...
							<ul class="list-unstyled collapse" id="pageSubmenu2">
								<li>
									...
									href="/CGA105G2/front-end/member/order/listOrderNoYet.html">🔆待出貨</a>
								</li>
								<li><a class="nav-link "
									href="/CGA105G2/front-end/member/order/listOrderScore.html">🔆待評價</a>
								</li>
								<li><a class="nav-link "
									href="/CGA105G2/front-end/member/order/selectlistOrder.html">🔆歷史查詢</a>
									<hr>
							</ul></li>
						<li><a href="#pageSubmenu3" data-toggle="collapse"
							...
							<ul class="collapse list-unstyled" id="pageSubmenu3">
								<li>
									<hr> <a class="nav-link "
									href="/CGA105G2/front-end/member/food_order/listAllFoodOrder.html">🔆已預約</a>
								</li>
								<li><a class="nav-link "
									href="/CGA105G2/front-end/member/food_order/listFoodOrderScore.html">🔆用餐評價</a></li>
								<li><a class="nav-link "
									href="/CGA105G2/front-end/member/food_order/selectListFoodOrderHistory.html">🔆訂位紀錄</a>
									<hr></li>
							</ul></li>
						<li><a href="#pageSubmenu4" data-toggle="collapse"
							...
							<ul class="collapse list-unstyled" id="pageSubmenu4">
								<li>
									<hr> <a class="nav-link "
									href="/CGA105G2/front-end/member/member/listMemberInfo.html">🔆基本資料</a>
								</li>
								<li><a class="nav-link "
									href="/CGA105G2/front-end/member/member/setMemberAddress.html">🔆收件地址</a></li>
								<li><a class="nav-link "
									href="/CGA105G2/front-end/member/member/setMemberPay.html">🔆付款方式</a></li>
								<li><a class="nav-link "
									href="/CGA105G2/front-end/member/member/updateMemberPassWord.html">🔆變更密碼</a>
									<hr></li>
							</ul></li>
					</ul>
				</div>
			...
			<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 my-5">
				...
				<canvas class="my-4 w-100" width="900" height="300"></canvas>
			</main>
		</div>
	</div>
